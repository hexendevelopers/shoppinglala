    ...
    async function fetchCollections() {
      try {
        ...
        if (data.errors) {
          ...
          // Filter for Featured Products collection only
          const featuredCollection = data.data.collections.edges.find(
            (collection: any) => collection.node.title === "Featured Products"
          );
          setCollections(featuredCollection ? [featuredCollection] : []);
        }
      } catch (error) {
