    ...
    async function fetchCollections() {
      try {
        ...
        if (data.errors) {
          ...
          const latestProductsCollection = data.data.collections.edges.find(
            (collection: any) => collection.node.title === "Latest Products"
          );
          console.log("Latest Products Collection:", latestProductsCollection); // Debug log
          if (!latestProductsCollection) {
            setError("Latest Products collection not found");
            return;
          }
          setCollections([latestProductsCollection]);
        }
      } catch (error) {
